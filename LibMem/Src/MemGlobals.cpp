...
Vec3f calcNormal( const Vec3f& v0, const Vec3f& v1,
					const Vec3f& v2 )
{
	Vec3f normal;
...
Mat4f
hornMethodQuat( const std::vector<Vec3f>& p0,
				...
				const std::vector<unsigned int>& idx )
{
	...
	// calculate mean of the two point sets
	meanp0 = meanVec3f( p0, idx );
	meanp1 = meanVec3f( p1, idx );
